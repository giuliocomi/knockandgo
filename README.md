...
Note: clients and server exchange messages encrypted with RSA, so to correctly send and read their content, it is necessary that the 4 .pem files are generated in advanced and shared between clients and server.
